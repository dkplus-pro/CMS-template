...
const listDictItems = (
    code: string,
      ...
      {url: `/dicts/${code}/items`, method: 'GET'
    },
      );
    }
  /**
...
const createDictItem = (
    ...
    dictEntryUpsertRequest: DictEntryUpsertRequest,
      ...
      return customInstance<DictEntry>(
      {url: `/dicts/${code}/items`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
