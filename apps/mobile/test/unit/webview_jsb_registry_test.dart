// webview JSB 装配单测(A 系列,方案 §6.6):三组 handler 全量注册、无重复、可分发。
...
void main() {
  test('A1 装配完整性:methodCount == 9,三组清单逐一 hasMethod', () {
  ...
  test('A2 无重复注册:三组清单拼接后 toSet().length == 9', () {
    ...
    expect(allNames.toSet().length, 9);
